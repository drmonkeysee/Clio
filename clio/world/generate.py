...
# ---------------------------------------------------------------------------
# Random generation (spatially unstructured)
# ---------------------------------------------------------------------------
...
def generate_random(
    ...
    as a visual proof-of-concept for the rendering pipeline; use `generate`
    for structured, noise-driven terrain instead.
    """
...
# ---------------------------------------------------------------------------
# Noise-based generation (design §1.3)
# ---------------------------------------------------------------------------
...
_TEMP_SEED_OFFSET: int = 2_000_003
